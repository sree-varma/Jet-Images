...
path=''
path1='/home/k1629656/Jets/Herwig/herwig_gg2qqbar/'
path2='/home/k1629656/Jets/Herwig/herwig_qq2qq/'  # Path of the program
path3='/home/k1629656/Jets/Herwig/herwig_qqbar2qqbar/'
impath='/home/k1629656/Jets/quarks'#'/usr/Herwig/quark_jets/images_100-110GeV'# _100-110GeV/' # Folder to which the image files are saving 
imageFile1='herwig_gg2qqbar_40000_100-110_jet_image.dat'  # The generated data from Herwig simulation
imageFile2='herwig_qq2qq_40000_100-110_jet_image.dat'
imageFile3='herwig_qqbar2qqbar_40000_100-110_jet_image.dat'
df_image1 = pd.read_csv(path1+imageFile1,dtype=None,delimiter=",")
df_image2 = pd.read_csv(path2+imageFile2,dtype=None,delimiter=",")
df_image3 = pd.read_csv(path3+imageFile3,dtype=None,delimiter=",") 
df_image = pd.concat([df_image1,df_image2,df_image3],ignore_index=True,axis=0)

#df_image.to_csv('herwig_quark_jet_120000_100-110_jet_image.dat',index = False)
#imageFile = 'herwig_quark_jet_120000_100-110_jet_image.dat'
#df_image=pd.read_csv(path+imageFile,dtype= None, delimiter=",")   # Data=> Dataframe
df_image= df_image.iloc[:113420,:] # index of the last line in 125000th Jet
...
plt.grid(True)
av1_imfile ='av_image_before_step4-5_herwig3_4_5_.jpeg'
...
for index,j in enumerate(g_i): # For all values and their corresponding indices in g_i      
        if g_i[index-1]+1<g_i[index]:
               ...
               # fig_size[1] = 0.4155844155
                ...
                imfile ='image_herwig3_4_5_%002d.jpeg'%index# Name image files as image_01.png
...
#cb.set_label('Transverse momentum of final state particles in a Jet (GeV)')
plt.grid(True)
av2_imfile ='av_image_herwig3_4_5_.jpeg'
